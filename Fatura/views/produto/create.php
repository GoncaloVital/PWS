                        ...
                        <form action="router.php?c=produto&a=store" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Referencia" name="referencia" minlength="11" maxlength="50" value="<?php if(isset($produtos)) { echo $produtos->referencia; }?>">
                                ...
                                <div class="form-group">
                                    <label>Preço</label>
                                    <input type="number" class="form-control" placeholder="Preço €" name="preco" value="<?php if(isset($produtos)) { echo $produtos->preco; }?>">
