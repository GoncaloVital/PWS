...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Registar Funcionario</h1>
                </div><!-- /.col -->
                        ...
                        <form action="router.php?c=funcionario&a=store" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Telefone" name="telefone" minlength="9" maxlength="9" value="<?php if(isset($users)) { echo $users->telefone; }?>">
                                    <?php if(isset($users->errors)){ echo $users->errors->on('telefone'); }?>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">NIF</label>
                                    <input type="text" class="form-control" placeholder="NIF" name="nif"  minlength="9" maxlength="9" value="<?php if(isset($users)) { echo $users->nif; }?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  placeholder="Codigo Postal" name="codpostal" maxlength="9" value="<?php if(isset($users)) { echo $users->codpostal; }?>">
                                    <?php if(isset($users->errors)){ echo $users->errors->on('codpostal'); }?>
                                </div>
                                <div class="form-group">
